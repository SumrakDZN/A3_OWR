...
switch _mode do {
	case "onLoad": {
		...
		// owr stuff
		_ctrl = _display displayctrl 11221;
		_ctrl = _display displayctrl 11222;
		_ctrl = _display displayctrl 11223;
		_ctrl = _display displayctrl 11224;
	...
	case "keyDown": {
		...
		if (_ctrl) then {
			uinamespace setvariable ["owr_rotleftctrl", true];
		};
	...
	case "keyUp": {
		_key = _params select 1;
		uinamespace setvariable ["owr_rotleftctrl", false];
