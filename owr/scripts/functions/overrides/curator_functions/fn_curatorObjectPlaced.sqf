...
_curatorInfoType = gettext (configfile >> "cfgvehicles" >> typeof _object >> "curatorInfoType");
_filterAttributes = getnumber (configfile >> _curatorInfoType >> "filterAttributes");

if (_filterAttributes == 0) then {_object call bis_fnc_showCuratorAttributes;};
