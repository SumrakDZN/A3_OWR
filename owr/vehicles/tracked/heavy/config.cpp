class CfgPatches {
	class owr_am_vehicles_tracked_heavy {
		author = "Sumrak";
		name = "OWR - AM Tracked Heavy";
...
class CfgVehicles {
	...
	// BASE CLASS
	class owr_am_heavy_tracked: owr_car_am {
		scope	= 0;
		scopeCurator = 0;
	...
	class owr_am_heavy_tracked_combustion: owr_am_heavy_tracked {
		scope = 0;
	...
	class owr_am_heavy_tracked_siberite: owr_am_heavy_tracked {
		scope = 0;
	...
	// AI classes
	class owr_am_heavy_tracked_combustion_ai: owr_am_heavy_tracked_combustion {
		crew = "B_UAV_AI";
	...
	class owr_am_heavy_tracked_siberite_ai: owr_am_heavy_tracked_siberite {
		crew = "B_UAV_AI";
		typicalCargo[] = {"B_UAV_AI", "B_UAV_AI"};
		class EventHandlers {
	...
	// CB - MN - CARGO
	class owr_am_hv_tr_mn_cb_cargo: owr_am_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\tracked\heavy\mn_cargo.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\actions\icon_action_pickup_type_ca.paa";

		displayName = "AM Heavy Comb Cargo";
	...
	// SB - MN - CARGO
	class owr_am_hv_tr_mn_sb_cargo: owr_am_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Heavy Siberite Cargo";
	...
	// CB - MN - HGUN
	class owr_am_hv_tr_mn_cb_hgun: owr_am_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\tracked\heavy\mn_hgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_heavy_gun_ca.paa";

		displayName = "AM Heavy Comb Heavy Cannon";
	...
	// SB - MN - HGUN
	class owr_am_hv_tr_mn_sb_hgun: owr_am_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Heavy Siberite Heavy Cannon";
	...
	// CB - MN - RLAN
	class owr_am_hv_tr_mn_cb_rlan: owr_am_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\tracked\heavy\mn_rlan.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_rocket_launcher_ca.paa";

		displayName = "AM Heavy Comb Rocket Launcher";
	...
	// SB - MN - RLAN
	class owr_am_hv_tr_mn_sb_rlan: owr_am_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Heavy Siberite Rocket Launcher";
	...
	// CB - MN - LASER
	class owr_am_hv_tr_mn_cb_laser: owr_am_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\tracked\heavy\mn_laser.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_laser_ca.paa";

		displayName = "AM Heavy Comb Laser";
	...
	// SB - MN - LASER
	class owr_am_hv_tr_mn_sb_laser: owr_am_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Heavy Siberite Laser";
	...
	// CB - MN - DGUN
	class owr_am_hv_tr_mn_cb_dgun: owr_am_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\tracked\heavy\mn_dgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_heavy_gun_ca.paa";

		displayName = "AM Heavy Comb Double Cannon";
	...
	// SB - MN - DGUN
	class owr_am_hv_tr_mn_sb_dgun: owr_am_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Heavy Siberite Double Cannon";
	...
	// CB - AI - CARGO
	class owr_am_hv_tr_ai_cb_cargo: owr_am_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - CARGO
	class owr_am_hv_tr_ai_sb_cargo: owr_am_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - HGUN
	class owr_am_hv_tr_ai_cb_hgun: owr_am_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - HGUN
	class owr_am_hv_tr_ai_sb_hgun: owr_am_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - RLAN
	class owr_am_hv_tr_ai_cb_rlan: owr_am_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - RLAN
	class owr_am_hv_tr_ai_sb_rlan: owr_am_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - LASER
	class owr_am_hv_tr_ai_cb_laser: owr_am_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - LASER
	class owr_am_hv_tr_ai_sb_laser: owr_am_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - DGUN
	class owr_am_hv_tr_ai_cb_dgun: owr_am_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - DGUN
	class owr_am_hv_tr_ai_sb_dgun: owr_am_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
