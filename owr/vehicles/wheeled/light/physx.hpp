		...
		maxSpeed               	= 95; 		/// vehicle can go a bit over, but dramatically decreases thrust
		fuelCapacity           	= 45; 
		wheelCircumference     	= 2.199; 	/// diameter of 725

		antiRollbarForceCoef	= 10.5; 	/// how strong is the anti-roll bar of vehicle preventing it to lose grip in turns (not any magical stuff, real ARB)
		antiRollbarForceLimit	= 10.5; 	/// highest possible force of ARB
