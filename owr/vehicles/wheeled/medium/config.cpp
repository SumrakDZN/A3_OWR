class CfgPatches {
	class owr_am_vehicles_wheeled_medium {
		author = "Sumrak";
		name = "OWR - AM Wheeled Medium";
...
class CfgVehicles {
	...
	// BASE CLASS
	class owr_am_medium_wheeled: owr_car_am {
		scope	= 0;
		scopeCurator = 0;
	...
	class owr_am_medium_wheeled_combustion: owr_am_medium_wheeled {
		scope = 0;
		...
		class EventHandlers {
			init = "(_this select 0) animateSource ['hide_siberite', 1, true]; (_this select 0) animateSource ['hide_solar', 1, true]; (_this select 0) animateSource ['hide_ai', 1, true];";
		};
	};
	class owr_am_medium_wheeled_electric: owr_am_medium_wheeled {
		scope = 0;
		...
		class EventHandlers {
			init = "(_this select 0) animateSource ['hide_siberite', 1, true]; (_this select 0) animateSource ['hide_comb', 1, true]; (_this select 0) animateSource ['hide_ai', 1, true];";
		};
	...
	class owr_am_medium_wheeled_siberite: owr_am_medium_wheeled {
		scope = 0;
		// change properties for the electric engine
		// will be used in the future for further tweaks of physx
		fuelCapacity = 10000;
		...
		class EventHandlers {
			init = "(_this select 0) animateSource ['hide_solar', 1, true]; (_this select 0) animateSource ['hide_comb', 1, true]; (_this select 0) animateSource ['hide_ai', 1, true];";
		};
	...
	// AI classes
	class owr_am_medium_wheeled_combustion_ai: owr_am_medium_wheeled_combustion {
		crew = "B_UAV_AI";
		typicalCargo[] = {"B_UAV_AI", "B_UAV_AI"};
		class EventHandlers {
			init = "(_this select 0) animateSource ['hide_siberite', 1, true]; (_this select 0) animateSource ['hide_solar', 1, true]; (_this select 0) animateSource ['hide_mn', 1, true];";
		};
	};
	class owr_am_medium_wheeled_electric_ai: owr_am_medium_wheeled_electric {
		crew = "B_UAV_AI";
		typicalCargo[] = {"B_UAV_AI", "B_UAV_AI"};
		class EventHandlers {
			init = "(_this select 0) animateSource ['hide_siberite', 1, true]; (_this select 0) animateSource ['hide_comb', 1, true]; (_this select 0) animateSource ['hide_mn', 1, true];";
		};
	};
	class owr_am_medium_wheeled_siberite_ai: owr_am_medium_wheeled_siberite {
		crew = "B_UAV_AI";
		typicalCargo[] = {"B_UAV_AI", "B_UAV_AI"};
		class EventHandlers {
			init = "(_this select 0) animateSource ['hide_comb', 1, true]; (_this select 0) animateSource ['hide_solar', 1, true]; (_this select 0) animateSource ['hide_mn', 1, true];";
		};
	};
	...
	// CB - MN - CARGO
	class owr_am_me_wh_mn_cb_cargo: owr_am_medium_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\wheeled\medium\mn_cargo.p3d";
	...
	// EL - MN - CARGO
	class owr_am_me_wh_mn_el_cargo: owr_am_medium_wheeled_electric {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Medium Electric Cargo";
	...
	// SB - MN - CARGO
	class owr_am_me_wh_mn_sb_cargo: owr_am_medium_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - CARGO
	class owr_am_me_wh_ai_cb_cargo: owr_am_medium_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// EL - AI - CARGO
	class owr_am_me_wh_ai_el_cargo: owr_am_medium_wheeled_electric_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - CARGO
	class owr_am_me_wh_ai_sb_cargo: owr_am_medium_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - RADAR
	class owr_am_me_wh_mn_cb_radar: owr_am_medium_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\wheeled\medium\mn_radar.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// EL - MN - RADAR
	class owr_am_me_wh_mn_el_radar: owr_am_medium_wheeled_electric {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Medium Electric Radar";
	...
	// SB - MN - RADAR
	class owr_am_me_wh_mn_sb_radar: owr_am_medium_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - RADAR
	class owr_am_me_wh_ai_cb_radar: owr_am_medium_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// EL - AI - RADAR
	class owr_am_me_wh_ai_el_radar: owr_am_medium_wheeled_electric_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - RADAR
	class owr_am_me_wh_ai_sb_radar: owr_am_medium_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - MACHINE GUN
	class owr_am_me_wh_mn_cb_mgun: owr_am_medium_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\wheeled\medium\mn_mgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// CB - MN - LIGHT GUN
	class owr_am_me_wh_mn_cb_lgun: owr_am_medium_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\wheeled\medium\mn_lgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_gun_ca.paa";
	...
	// CB - MN - LASER
	class owr_am_me_wh_mn_cb_laser: owr_am_medium_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\wheeled\medium\mn_laser.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// CB - MN - MINIGUN
	class owr_am_me_wh_mn_cb_rgun: owr_am_medium_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\wheeled\medium\mn_rgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	class owr_am_me_wh_mn_cb_rlan: owr_am_medium_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\wheeled\medium\mn_rlan.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// CB - MN - DOUBLE CANNON
	class owr_am_me_wh_mn_cb_dgun: owr_am_medium_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\wheeled\medium\mn_dgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// EL - MN - MACHINE GUN
	class owr_am_me_wh_mn_el_mgun: owr_am_medium_wheeled_electric {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Medium Electric Machine Gun";
	...
	// EL - MN - LIGHT GUN
	class owr_am_me_wh_mn_el_lgun: owr_am_medium_wheeled_electric {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Medium Electric Light Cannon";
	...
	// EL - MN - LASER
	class owr_am_me_wh_mn_el_laser: owr_am_medium_wheeled_electric {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Medium Electric Laser";
	...
	// EL - MN - MINIGUN
	class owr_am_me_wh_mn_el_rgun: owr_am_medium_wheeled_electric {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Medium Electric Minigun";
	...
	// EL - MN - ROCKET LAUNCHER
	class owr_am_me_wh_mn_el_rlan: owr_am_medium_wheeled_electric {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Medium Electric Rocket Launcher";
	...
	// EL - MN - DOUBLE CANNON
	class owr_am_me_wh_mn_el_dgun: owr_am_medium_wheeled_electric {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "AM Medium Electric Double Cannon";
	...
	// SB - MN - MACHINE GUN
	class owr_am_me_wh_mn_sb_mgun: owr_am_medium_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - MN - LIGHT GUN
	class owr_am_me_wh_mn_sb_lgun: owr_am_medium_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - MN - LASER
	class owr_am_me_wh_mn_sb_laser: owr_am_medium_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - MN - MINIGUN
	class owr_am_me_wh_mn_sb_rgun: owr_am_medium_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	class owr_am_me_wh_mn_sb_rlan: owr_am_medium_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - MN - DOUBLE CANNON
	class owr_am_me_wh_mn_sb_dgun: owr_am_medium_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - MACHINE GUN
	class owr_am_me_wh_ai_cb_mgun: owr_am_medium_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - LIGHT GUN
	class owr_am_me_wh_ai_cb_lgun: owr_am_medium_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - LASER
	class owr_am_me_wh_ai_cb_laser: owr_am_medium_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - MINIGUN
	class owr_am_me_wh_ai_cb_rgun: owr_am_medium_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	class owr_am_me_wh_ai_cb_rlan: owr_am_medium_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - DOUBLE CANNON
	class owr_am_me_wh_ai_cb_dgun: owr_am_medium_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// EL - AI - MACHINE GUN
	class owr_am_me_wh_ai_el_mgun: owr_am_medium_wheeled_electric_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// EL - AI - LIGHT GUN
	class owr_am_me_wh_ai_el_lgun: owr_am_medium_wheeled_electric_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// EL - AI - LASER
	class owr_am_me_wh_ai_el_laser: owr_am_medium_wheeled_electric_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// EL - AI - MINIGUN
	class owr_am_me_wh_ai_el_rgun: owr_am_medium_wheeled_electric_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// EL - AI - ROCKET LAUNCHER
	class owr_am_me_wh_ai_el_rlan: owr_am_medium_wheeled_electric_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// EL - AI - DOUBLE CANNON
	class owr_am_me_wh_ai_el_dgun: owr_am_medium_wheeled_electric_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - MACHINE GUN
	class owr_am_me_wh_ai_sb_mgun: owr_am_medium_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - LIGHT GUN
	class owr_am_me_wh_ai_sb_lgun: owr_am_medium_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - LASER
	class owr_am_me_wh_ai_sb_laser: owr_am_medium_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - MINIGUN
	class owr_am_me_wh_ai_sb_rgun: owr_am_medium_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	class owr_am_me_wh_ai_sb_rlan: owr_am_medium_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - DOUBLE CANNON
	class owr_am_me_wh_ai_sb_dgun: owr_am_medium_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
