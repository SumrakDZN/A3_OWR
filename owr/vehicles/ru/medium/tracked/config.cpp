class CfgPatches {
	class owr_ru_vehicles_tracked_medium {
		author = "Sumrak";
		name = "OWR - RU Tracked Medium";
...
class CfgVehicles {
	...
	// BASE CLASS
	class owr_ru_medium_tracked: owr_car_ru {
		scope	= 0;
		scopeCurator = 0;
	...
	class owr_ru_medium_tracked_combustion: owr_ru_medium_tracked {
		scope = 0;
	...
	class owr_ru_medium_tracked_siberite: owr_ru_medium_tracked {
		scope = 0;
	...
	// AI classes
	class owr_ru_medium_tracked_combustion_ai: owr_ru_medium_tracked_combustion {
		crew = "O_UAV_AI";
	...
	class owr_ru_medium_tracked_siberite_ai: owr_ru_medium_tracked_siberite {
		crew = "O_UAV_AI";
		typicalCargo[] = {"O_UAV_AI", "O_UAV_AI"};
	...
	class owr_ru_me_tr_mn_cb_hmgun: owr_ru_medium_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\medium\tracked\mn_hmgun.p3d";
	...
	class owr_ru_me_tr_mn_sb_hmgun: owr_ru_medium_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	class owr_ru_me_tr_ai_cb_hmgun: owr_ru_medium_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	class owr_ru_me_tr_ai_sb_hmgun: owr_ru_medium_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - MINIGUN
	class owr_ru_me_tr_mn_cb_rgun: owr_ru_medium_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\medium\tracked\mn_rgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// SB - MN - MINIGUN
	class owr_ru_me_tr_mn_sb_rgun: owr_ru_medium_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - MINIGUN
	class owr_ru_me_tr_ai_cb_rgun: owr_ru_medium_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - MINIGUN
	class owr_ru_me_tr_ai_sb_rgun: owr_ru_medium_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - CANNON
	class owr_ru_me_tr_mn_cb_gun: owr_ru_medium_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\medium\tracked\mn_gun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_gun_ca.paa";
	...
	// SB - MN - CANNON
	class owr_ru_me_tr_mn_sb_gun: owr_ru_medium_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - CANNON
	class owr_ru_me_tr_ai_cb_gun: owr_ru_medium_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - CANNON
	class owr_ru_me_tr_ai_sb_gun: owr_ru_medium_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - RLAN
	class owr_ru_me_tr_mn_cb_rlan: owr_ru_medium_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\medium\tracked\mn_rlan.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// SB - MN - RLAN
	class owr_ru_me_tr_mn_sb_rlan: owr_ru_medium_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - RLAN
	class owr_ru_me_tr_ai_cb_rlan: owr_ru_medium_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - RLAN
	class owr_ru_me_tr_ai_sb_rlan: owr_ru_medium_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - CARGO
	class owr_ru_me_tr_mn_cb_cargo: owr_ru_medium_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\medium\tracked\mn_cargo.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// SB - MN - CARGO
	class owr_ru_me_tr_mn_sb_cargo: owr_ru_medium_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - CARGO
	class owr_ru_me_tr_ai_cb_cargo: owr_ru_medium_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - CARGO
	class owr_ru_me_tr_ai_sb_cargo: owr_ru_medium_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
