class CfgPatches {
	class owr_ru_vehicles_wheeled_heavy {
		author = "Sumrak";
		name = "OWR - RU Wheeled Heavy";
...
class CfgVehicles {
	...
	// BASE CLASS
	class owr_ru_heavy_wheeled: owr_car_ru {
		scope	= 0;
		scopeCurator = 0;
	...
	class owr_ru_heavy_wheeled_combustion: owr_ru_heavy_wheeled {
		scope = 0;
	...
	class owr_ru_heavy_wheeled_siberite: owr_ru_heavy_wheeled {
		scope = 0;
	...
	// AI classes
	class owr_ru_heavy_wheeled_combustion_ai: owr_ru_heavy_wheeled_combustion {
		crew = "O_UAV_AI";
	...
	class owr_ru_heavy_wheeled_siberite_ai: owr_ru_heavy_wheeled_siberite {
		crew = "O_UAV_AI";
		typicalCargo[] = {"O_UAV_AI", "O_UAV_AI"};
		class EventHandlers {
	...
	class owr_ru_hv_wh_mn_cb_hmgun: owr_ru_heavy_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\wheeled\mn_hmgun.p3d";
	...
	class owr_ru_hv_wh_mn_sb_hmgun: owr_ru_heavy_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	class owr_ru_hv_wh_ai_cb_hmgun: owr_ru_heavy_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	class owr_ru_hv_wh_ai_sb_hmgun: owr_ru_heavy_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - MINIGUN
	class owr_ru_hv_wh_mn_cb_rgun: owr_ru_heavy_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\wheeled\mn_rgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// SB - MN - MINIGUN
	class owr_ru_hv_wh_mn_sb_rgun: owr_ru_heavy_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - MINIGUN
	class owr_ru_hv_wh_ai_cb_rgun: owr_ru_heavy_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - MINIGUN
	class owr_ru_hv_wh_ai_sb_rgun: owr_ru_heavy_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - CANNON
	class owr_ru_hv_wh_mn_cb_gun: owr_ru_heavy_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\wheeled\mn_gun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_gun_ca.paa";
	...
	// SB - MN - CANNON
	class owr_ru_hv_wh_mn_sb_gun: owr_ru_heavy_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - CANNON
	class owr_ru_hv_wh_ai_cb_gun: owr_ru_heavy_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - CANNON
	class owr_ru_hv_wh_ai_sb_gun: owr_ru_heavy_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - HEAVY CANNON
	class owr_ru_hv_wh_mn_cb_hgun: owr_ru_heavy_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\wheeled\mn_hgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// SB - MN - HEAVY CANNON
	class owr_ru_hv_wh_mn_sb_hgun: owr_ru_heavy_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - HEAVY CANNON
	class owr_ru_hv_wh_ai_cb_hgun: owr_ru_heavy_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - HEAVY CANNON
	class owr_ru_hv_wh_ai_sb_hgun: owr_ru_heavy_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - RLAN
	class owr_ru_hv_wh_mn_cb_rlan: owr_ru_heavy_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\wheeled\mn_rlan.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// SB - MN - RLAN
	class owr_ru_hv_wh_mn_sb_rlan: owr_ru_heavy_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - RLAN
	class owr_ru_hv_wh_ai_cb_rlan: owr_ru_heavy_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - RLAN
	class owr_ru_hv_wh_ai_sb_rlan: owr_ru_heavy_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - ROCKET
	class owr_ru_hv_wh_mn_cb_rocket: owr_ru_heavy_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\wheeled\mn_rocket.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// SB - MN - ROCKET
	class owr_ru_hv_wh_mn_sb_rocket: owr_ru_heavy_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - ROCKET
	class owr_ru_hv_wh_ai_cb_rocket: owr_ru_heavy_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - ROCKET
	class owr_ru_hv_wh_ai_sb_rocket: owr_ru_heavy_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - CARGO
	class owr_ru_hv_wh_mn_cb_cargo: owr_ru_heavy_wheeled_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\wheeled\mn_cargo.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
	...
	// SB - MN - CARGO
	class owr_ru_hv_wh_mn_sb_cargo: owr_ru_heavy_wheeled_siberite {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - AI - CARGO
	class owr_ru_hv_wh_ai_cb_cargo: owr_ru_heavy_wheeled_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - CARGO
	class owr_ru_hv_wh_ai_sb_cargo: owr_ru_heavy_wheeled_siberite_ai {
		scope = 2;
		scopeCurator = 2;
