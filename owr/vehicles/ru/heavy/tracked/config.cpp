class CfgPatches {
	class owr_ru_vehicles_tracked_heavy {
		author = "Sumrak";
		name = "OWR - RU Tracked Heavy";
...
class CfgVehicles {
	...
	// BASE CLASS
	class owr_ru_heavy_tracked: owr_car_ru {
		scope	= 0;
		scopeCurator = 0;
		...
		textureTrackWheel = 0;
		memoryPointTrack1L = "TrackFLL";
		memoryPointTrack1R = "TrackBLL";
		memoryPointTrack2L = "TrackFRR";
		memoryPointTrack2R = "TrackBRR";
	...
	class owr_ru_heavy_tracked_combustion: owr_ru_heavy_tracked {
		scope = 0;
		...
		Icon = "\owr\ui\data\actions\icon_man_start_ca.paa";

		class EventHandlers {
			init = "(_this select 0) animateSource ['hide_siberite', 1, true]; (_this select 0) animateSource ['hide_ai', 1, true];";
		};
	};
	class owr_ru_heavy_tracked_siberite: owr_ru_heavy_tracked {
		scope = 0;
	...
	// AI classes
	class owr_ru_heavy_tracked_combustion_ai: owr_ru_heavy_tracked_combustion {
		crew = "O_UAV_AI";
		typicalCargo[] = {"O_UAV_AI", "O_UAV_AI"};

		Icon = "\owr\ui\data\research\icon_res_adv_ai_ca.paa";

		class EventHandlers {
			init = "(_this select 0) animateSource ['hide_siberite', 1, true]; (_this select 0) animateSource ['hide_mn', 1, true];";
		};
	};
	class owr_ru_heavy_tracked_siberite_ai: owr_ru_heavy_tracked_siberite {
		crew = "O_UAV_AI";
		typicalCargo[] = {"O_UAV_AI", "O_UAV_AI"};
	...
	class owr_ru_hv_tr_mn_cb_hmgun: owr_ru_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\tracked\mn_hmgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_gun_ca.paa";

		displayName = "RU Heavy Comb Heavy Machine Gun";
	...
	class owr_ru_hv_tr_mn_sb_hmgun: owr_ru_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "RU Heavy Alaskite Heavy Machine Gun";
	...
	class owr_ru_hv_tr_ai_cb_hmgun: owr_ru_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	class owr_ru_hv_tr_ai_sb_hmgun: owr_ru_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - MINIGUN
	class owr_ru_hv_tr_mn_cb_rgun: owr_ru_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\tracked\mn_rgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_rot_mgun_ca.paa";

		displayName = "RU Heavy Comb Minigun";
	...
	// SB - MN - MINIGUN
	class owr_ru_hv_tr_mn_sb_rgun: owr_ru_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "RU Heavy Alaskite Minigun";
	...
	// CB - AI - MINIGUN
	class owr_ru_hv_tr_ai_cb_rgun: owr_ru_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - MINIGUN
	class owr_ru_hv_tr_ai_sb_rgun: owr_ru_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - HEAVY CANNON
	class owr_ru_hv_tr_mn_cb_hgun: owr_ru_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\tracked\mn_hgun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_heavy_gun_ca.paa";

		displayName = "RU Heavy Comb Heavy Cannon";
	...
	// SB - MN - HEAVY CANNON
	class owr_ru_hv_tr_mn_sb_hgun: owr_ru_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "RU Heavy Alaskite Heavy Cannon";
	...
	// CB - AI - HEAVY CANNON
	class owr_ru_hv_tr_ai_cb_hgun: owr_ru_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - HEAVY CANNON
	class owr_ru_hv_tr_ai_sb_hgun: owr_ru_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - CANNON
	class owr_ru_hv_tr_mn_cb_gun: owr_ru_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\tracked\mn_gun.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_gun_ca.paa";

		displayName = "RU Heavy Comb Cannon";
	...
	// SB - MN - CANNON
	class owr_ru_hv_tr_mn_sb_gun: owr_ru_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "RU Heavy Alaskite Cannon";
	...
	// CB - AI - CANNON
	class owr_ru_hv_tr_ai_cb_gun: owr_ru_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - CANNON
	class owr_ru_hv_tr_ai_sb_gun: owr_ru_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - RLAN
	class owr_ru_hv_tr_mn_cb_rlan: owr_ru_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\tracked\mn_rlan.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_rocket_launcher_ca.paa";

		displayName = "RU Heavy Comb Rocket Launcher";
	...
	// SB - MN - RLAN
	class owr_ru_hv_tr_mn_sb_rlan: owr_ru_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "RU Heavy Alaskite Rocket Launcher";
	...
	// CB - AI - RLAN
	class owr_ru_hv_tr_ai_cb_rlan: owr_ru_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - RLAN
	class owr_ru_hv_tr_ai_sb_rlan: owr_ru_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - ROCKET
	class owr_ru_hv_tr_mn_cb_rocket: owr_ru_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\tracked\mn_rocket.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\research\icon_res_weap_rocket_ca.paa";

		displayName = "RU Heavy Comb Rocket";
		...
		class EventHandlers: EventHandlers {
			fired = "(_this select 0) addMagazineTurret ['owr_ru_m_rockets',[0],2];";
		};
	};
	// SB - MN - ROCKET
	class owr_ru_hv_tr_mn_sb_rocket: owr_ru_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "RU Heavy Siberite Rocket";
	...
	// CB - AI - ROCKET
	class owr_ru_hv_tr_ai_cb_rocket: owr_ru_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - ROCKET
	class owr_ru_hv_tr_ai_sb_rocket: owr_ru_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// CB - MN - CARGO
	class owr_ru_hv_tr_mn_cb_cargo: owr_ru_heavy_tracked_combustion {
		scope = 2;
		scopeCurator = 2;

		model 	= "\owr\vehicles\ru\heavy\tracked\mn_cargo.p3d";
		picture	= "\A3\Weapons_F\Data\placeholder_co.paa";
		Icon	= "\owr\ui\data\actions\icon_action_pickup_type_ca.paa";

		displayName = "RU Heavy Comb Cargo";
	...
	// SB - MN - CARGO
	class owr_ru_hv_tr_mn_sb_cargo: owr_ru_heavy_tracked_siberite {
		scope = 2;
		scopeCurator = 2;
		...
		displayName = "RU Heavy Alaskite Cargo";
	...
	// CB - AI - CARGO
	class owr_ru_hv_tr_ai_cb_cargo: owr_ru_heavy_tracked_combustion_ai {
		scope = 2;
		scopeCurator = 2;
	...
	// SB - AI - CARGO
	class owr_ru_hv_tr_ai_sb_cargo: owr_ru_heavy_tracked_siberite_ai {
		scope = 2;
		scopeCurator = 2;
